angular
    ...
    .directive('button', showMobileMenuToggler)
    .directive('button', mobileNavToggler)
    ...
    .directive('treantGraph', treantGraph);
...
function mobileNavToggler() {
    ...
    function link(scope, element, attrs) {
        element.on('click', function () {
            if (element.hasClass('mobile-nav-toggler')) {
                var result = document.getElementsByClassName('header-menu-wrapper header-menu-wrapper-left');
                console.log(result);
                angular.element(result).toggleClass('header-menu-wrapper-on');
            }
        });
    }
}
...
function showMobileMenuToggler() {
    var directive = {
        restrict: 'E',
        link: link,
    };
    ...
    function link(scope, element, attrs) {
        element.on('click', function () {
            if (element.hasClass('mobile-toggler')) {
                angular.element('body').toggleClass('topbar-mobile-on');
            }
        });
    }
}
...
function pagination() {
    var directive = {
        ...
        transclude: 'true',
        link: link,
        templateUrl: 'statics/members/partials/customs/pagination-directive.html',
        scope: {
            data: '=',
            pageSize: '=',
...
function treantGraph() {
    var directive = {
        ...
        template: '<div class="chart" id="member-chart"></div>',
    };
    return directive;

    function link(scope, element, attrs, ctrlFn) {
        scope.$watch(
            'data',
            function (newVal) {
                if (newVal) {
