...
(function (root, factory) {
    ...
    if ((typeof define).match(/^(object|function)$/) && define.amd) {
        ...
        module.exports = factory(require('angular'), require('videojs'));
    } else {
    ...
    module.controller('VjsVideoController', [
        ...
        function ($scope) {
            ...
            function generateMedia(ctrl, mediaChangedHandler) {
                var errMsgNoValid = 'a sources and/or tracks element must be ' + 'defined for the vjs-media attribute',
            ...
            function initVideoJs(vid, params, element, mediaChangedHandler) {
                var opts = params.vjsSetup || {},
                    ...
                    isValidContainer = !isMediaElement(element) && !getVersion().match(/^5\./) ? true : false,
                    mediaWatcher;
