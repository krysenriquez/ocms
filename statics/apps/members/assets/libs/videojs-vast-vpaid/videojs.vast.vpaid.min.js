        ...
        2: [
            function (t, e, i) {
                ...
                function s(t, e) {
                    ...
                    return e &&
                        ((typeof e === 'undefined' ? 'undefined' : n(e)) === 'object' || typeof e === 'function')
                        ? e
                        : t;
                }
                function o(t, e) {
                    ...
                    r(e, [
                        ...
                        },
                        {
                            ...
                            value: function p(t, e, i) {
                                ...
                                this._flash.callFlashMethod(
                                    'resizeAd',
                                    [this._flash.getWidth(), this._flash.getHeight(), i],
                                    n
                                );
                            },
                        },
            ...
            function (t, e, i) {
                ...
                var g = (function () {
                    function t(e, i) {
                        ...
                        if (!t.isSupported()) {
                            return m(
                                "user don't support flash or doesn't have the minimum required version of flash " + v
                            );
                        }
            ...
            function (t, e, i) {
                ...
                u.prototype.loadAdUnit = function A(t, e) {
                    ...
                    var r = n.createIframeWithContent(
                        ...
                        n.extend(
                            { iframeURL_JS: t, iframeID: this.getID(), origin: y() },
                        ...
                        S = (function () {
                            ...
                            if (
                                (typeof u.readyState !== t &&
                                    (u.readyState === 'complete' || u.readyState === 'interactive')) ||
                        ...
                        if (E.win && E.ie) {
                            ...
                            if (n) {
                                ...
                                if (r) {
                                    ...
                                    for (var s = 0; s < a; s++) {
                                        if (
                                            !(r[s].nodeType == 1 && r[s].nodeName === 'PARAM') &&
                                            !(r[s].nodeType == 8)
                                        ) {
            ...
            function (t, e, i) {
                ...
                f.prototype._getVASTAd = function (t, e) {
                    ...
                    function u(t) {
                        ...
                        if (e && e != 3 && e != 2) {
                            return new r(
                                'on VASTClient.getVASTAd.validateVASTTree, not supported VAST version "' + e + '"',
                                102
                            );
                        }
                        return null;
            ...
            function (t, e, i) {
                ...
                o.prototype.trackURLs = function u(t, e) {
                    if (s.isArray(t) && t.length > 0) {
                        e = s.extend(
                            { ASSETURI: this.assetURI, CONTENTPLAYHEAD: a.formatProgress(this.progress) },
                            e || {}
                        );
                        a.track(t, e);
                    }
        ...
        31: [
            function (t, e, i) {
                ...
                a.checkVPAIDInterface = function s(t) {
                    ...
                    function s(t) {
                        return (
                            r.isFunction(t.unsubscribe) || r.isFunction(t.removeEventListener) || r.isFunction(t.off)
                        );
                    }
                };
                    ...
                    return {
                        init: function e(i, a) {
                            ...
                            setTimeout(function () {
                                var t =
                                    i.controlBar &&
                                    (i.controlBar.getChild('timerControls') ||
                                        i.controlBar.getChild('currentTimeDisplay'));
                                if (t) {
            ...
            function (t, e, i) {
                ...
                e.exports = function h(t) {
                    ...
                    if (d.isDefined(y.adTagXML) && !d.isFunction(y.adTagXML)) {
                        return b(
                            new r('on VideoJS VAST plugin, the passed adTagXML option does not contain a function')
                        );
                    }
