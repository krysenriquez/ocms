...
!(function (e, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ? (module.exports = t(require('videojs'), require('global/window'), require('global/document')))
        : 'function' == typeof define && define.amd
        ? define(['videojs', 'global/window', 'global/document'], t)
    ...
    var o = function (e, t) {
        ...
        i = function (e, t) {
            e.ads.isInAdMode() &&
                (e.ads.isContentResuming() ? e.ads._contentEnding && r(e, 'content', t) : r(e, 'ad', t));
        },
        s = function (e, t) {
            e.ads.isInAdMode()
                ? e.ads.isContentResuming()
                    ...
                    : r(e, 'ad', t)
                : e.ads._contentHasEnded || e.ads.stitchedAds() || (r(e, 'content', t), e.trigger('readyforpostroll'));
        },
        d = function (e, t) {
            if (
                !(
                    ('loadstart' === t.type && !e.ads._hasThereBeenALoadStartDuringPlayerLife) ||
    ...
    function u(e) {
        'playing' === e.type
            ...
            : 'ended' === e.type
            ? s(this, e)
            : 'loadstart' === e.type || 'loadeddata' === e.type || 'loadedmetadata' === e.type
            ? d(this, e)
            : 'play' === e.type
            ? l(this, e)
            : this.ads.isInAdMode() && (this.ads.isContentResuming() ? r(this, 'content', e) : r(this, 'ad', e));
    }
    var c = function (e, t) {
    ...
    function y() {
        !1 !== this.ads._shouldBlockPlay &&
            (this.paused() || (this.ads.debug('Playback was canceled by cancelContentPlay'), this.pause()),
            (this.ads._cancelledPlay = !0));
    }
    f.processAdTrack = function (t, n, a, o) {
        t.ads.includedCues = {};
        for (var r = 0; r < n.length; r++) {
            ...
            var d = this.getCueId(t, i),
                l = i.startTime;
            if (p(t, d)) return void e.log('Skipping ad already seen with ID ' + d);
            o && o(t, s, d, l), a(t, s, d, l), g(t, d);
        }
    };
    var v = {},
        m = e;
    (v.isMiddlewareMediatorSupported = function () {
        return !m.browser.IS_IOS && !m.browser.IS_ANDROID && !!(m.use && m.middleware && m.middleware.TERMINATOR);
    }),
        (v.playMiddleware = function (t) {
            return {
        ...
        (v.testHook = function (e) {
            m = e;
        });
    var A = v.playMiddleware,
        S = v.isMiddlewareMediatorSupported,
        _ = function () {
        ...
        b = (function () {
            ...
            return (
                ...
                (n.startLinearAdMode = function () {
                    e.log.warn(
                        'Unexpected startLinearAdMode invocation (State via ' + this.constructor._getName() + ')'
                    );
                }),
                ...
                (n.skipLinearAdMode = function () {
                    e.log.warn(
                        'Unexpected skipLinearAdMode invocation (State via ' + this.constructor._getName() + ')'
                    );
                }),
    ...
    var C = (function (e) {
        ...
        return (
            ...
            (n.onPlaying = function () {
                var e = P.getState('ContentPlayback');
    ...
    var T = (function (e) {
        ...
        return (
            ...
            (n.onContentChanged = function (e) {
                var t = P.getState('BeforePreroll'),
                    n = P.getState('Preroll');
                e.ads.debug('Received contentchanged event (ContentState)'),
                    e.paused()
                        ? this.transitionTo(t)
                        : (this.transitionTo(n, !1), e.pause(), (e.ads._pausedOnContentupdate = !0));
            }),
            t
        );
    })(b);
    P.registerState('ContentState', T);
    var w,
        R = (function (t) {
            function n() {
        ...
        })(P.getState('ContentState'));
    P.registerState('AdsDone', R);
    var B = {
            start: function (t) {
                t.ads.debug('Starting ad break'),
                    ...
                    t.ads.shouldPlayContentBehindAd(t) && ((t.ads.preAdVolume_ = t.volume()), t.volume(0)),
                ...
                t.ads.debug('Ending ad break'),
                    ...
                    t.ads.shouldTakeSnapshots()
                        ? (function (t, n) {
                              ...
                              if ((void 0 === n && (n = function () {}), !0 === t.ads.disableNextSnapshotRestore))
                                  return (t.ads.disableNextSnapshotRestore = !1), delete t.ads.snapshot, void n();
                              var o,
                                  r = t.$('.vjs-tech'),
                                  i = 20,
                              ...
                              if (
                                  ('style' in a && r.setAttribute('style', a.style || ''), t.ads.videoElementRecycled())
                              )
        ...
        L = (function (t) {
            ...
            return (
                (a.init = function (e, t, n) {
                    if (((this.waitingForAdBreak = !0), e.addClass('vjs-ad-loading'), n || e.ads.nopreroll_))
                ...
                (a.onAdsReady = function (t) {
                    t.ads.inAdBreak()
                        ...
                        : (t.ads.debug('Received adsready event (Preroll)'), this.handleAdsReady());
                }),
                ...
                (a.resumeAfterNoPreroll = function (e) {
                    if (
                        ...
                        e.paused() && (e.ads._playRequested || e.ads._pausedOnContentupdate))
                    ) {
                        var t = e.play();
    ...
    P.registerState('BeforePreroll', M);
    var j = (function (e) {
        function t() {
            return e.apply(this, arguments) || this;
        }
        ...
        return (
            (n.init = function (e) {
                (e.ads.adType = 'midroll'), B.start(e), e.addClass('vjs-ad-loading');
            }),
    ...
    var N = (function (t) {
        ...
        return (
            ...
            (a.skipLinearAdMode = function () {
                ...
                t.ads.inAdBreak() || this.isContentResuming()
                    ? e.log.warn('Unexpected skipLinearAdMode invocation')
                    : (t.ads.debug('Postroll abort (skipLinearAdMode)'), t.trigger('adskip'), this.abort(t));
            }),
            (a.onAdTimeout = function (e) {
    ...
    var E = (function (e) {
        ...
        return (
            ...
            (n.onReadyForPostroll = function (e) {
                var t = P.getState('Postroll');
                e.ads.debug('Received readyforpostroll event'), this.transitionTo(t);
            }),
            (n.startLinearAdMode = function () {
                var e = P.getState('Midroll');
                this.transitionTo(e);
            }),
            t
        );
    })(P.getState('ContentState'));
    P.registerState('ContentPlayback', E);
    var I = (function (e) {
        function t() {
            return e.apply(this, arguments) || this;
        }
        ...
        return (
            ...
            (n.startLinearAdMode = function () {
                var e = P.getState('StitchedAdRoll');
                this.transitionTo(e);
            }),
            t
        );
    })(P.getState('ContentState'));
    P.registerState('StitchedContentPlayback', I);
    var x = (function (e) {
        function t() {
            return e.apply(this, arguments) || this;
        }
        ...
        return (
            ...
            (n.endLinearAdMode = function () {
                var e = P.getState('StitchedContentPlayback');
                B.end(this.player), this.transitionTo(e);
            }),
            t
        );
    })(P.getState('AdState'));
    P.registerState('StitchedAdRoll', x);
    var D = v.isMiddlewareMediatorSupported,
        O = e.getTech('Html5').Events,
        F = {
            timeout: 5e3,
        ...
        U = function (o) {
            var r = this,
                i = e.mergeOptions(F, o),
                s = [];
            O.concat(['firstplay', 'loadedalldata']).forEach(function (e) {
                -1 === s.indexOf(e) && s.push(e);
            }),
                r.on(s, u),
                D() ||
                    (function (t, n) {
                        n && e.log('Using cancelContentPlay to block content playback'), t.on('play', y);
                    })(r, i.debug),
                        ...
                        isLive: function (n) {
                            return (
                                ...
                                'boolean' == typeof n.ads.settings.contentIsLive
                                    ...
                                    : n.duration() === 1 / 0 || ('8' === e.browser.IOS_VERSION && 0 === n.duration())
                            );
                        },
                ...
                i.stitchedAds
                    ? (r.ads._state = new (P.getState('StitchedContentPlayback'))(r))
                    : (r.ads._state = new (P.getState('BeforePreroll'))(r)),
                r.ads._state.init(r),
                (r.ads.cueTextTracks = f),
                (r.ads.adMacroReplacement = function (a, o, r) {
                    ...
                    (d['{player.id}'] = this.options_['data-player']),
                    ...
                    h(this.mediainfo, d, 'custom_fields'),
                    h(this.mediainfo, d, 'customFields'),
                    d))
                        a = a.split(l).join(c(d[l], o));
                    for (var u in ((a = a.replace(/{pageVariable\.([^}]+)}/g, function (n, a) {
                        ...
                        return null === r
                            ...
                            ? (e.log.warn('Page variable "' + a + '" is not a supported type'), '')
                            : c(String(r), o);
                    })),
                    s))
                        a = a.replace(u, s[u]);
                    ...
                    (e.ads.contentSrc = e.currentSrc()),
                        ...
                        e.on('loadstart', function () {
                            if (!e.ads.inAdBreak()) {
                                var t = e.currentSrc();
                                t !== e.ads.contentSrc &&
                                    (e.ads._seenInitialLoadstart && e.trigger({ type: 'contentchanged' }),
                                    e.trigger({ type: 'contentupdate', oldValue: e.ads.contentSrc, newValue: t }),
                                    (e.ads.contentSrc = t)),
