        ...
        secondWalk: function (node, level, X, Y) {
            if (level <= this.CONFIG.maxDepth) {
                ...
                if (node.pseudo) {
                    ...
                    node.Y =
                        align === 'CENTER' ? yTmp + (levelHeight - nodesizeTmp) / 2 : align === 'TOP' ? yTmp + (levelHeight - nodesizeTmp) : yTmp;
                }
    ...
    TreeNode.prototype = {
        ...
        reset: function (nodeStructure, id, parentId, tree, stackParentId) {
            ...
            this.drawLineThrough =
                nodeStructure.drawLineThrough === false ? false : nodeStructure.drawLineThrough || tree.CONFIG.node.drawLineThrough;
                ...
                if (key.startsWith('data-')) {
                    ...
                    textElement.appendChild(
                        document.createTextNode(
                            this.text[key].val ? this.text[key].val : this.text[key] instanceof Object ? "'val' param missing!" : this.text[key]
                        )
                    );
