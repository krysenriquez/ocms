 ...
 */
'use strict';
angular.module('com.2fdevs.videogular', ['ngSanitize']).run([
    '$templateCache',
 ...
 *
 */
angular.module('com.2fdevs.videogular').controller('vgController', [
    '$scope',
    '$window',
    'vgConfigLoader',
    'vgFullscreen',
    ...
    'VG_STATES',
    'VG_VOLUME_KEY',
    function ($scope, $window, vgConfigLoader, vgFullscreen, VG_UTILS, VG_STATES, VG_VOLUME_KEY) {
        ...
        this.onUpdateTime = function (event) {
            ...
            if (
                ...
                event.target.duration != null &&
                event.target.duration != undefined &&
                event.target.duration != 1.7976931348623157e308
            ) {
                // Fake the duration and current time for virtual clips
                if (isVirtualClip) {
                    if (
                        hasStartTimePlayed &&
                        (event.target.currentTime < this.startTime ||
                            event.target.currentTime - this.startTime > this.virtualClipDuration)
                    ) {
                        this.onComplete();
                    } else {
 ...
 */
('use strict');
angular.module('com.2fdevs.videogular').directive('vgCrossorigin', [
    function () {
        return {
            restrict: 'A',
            require: '^videogular',
 ...
 */
('use strict');
angular.module('com.2fdevs.videogular').directive('vgLoop', [
    function () {
        return {
            restrict: 'A',
            require: '^videogular',
 ...
 */
('use strict');
angular.module('com.2fdevs.videogular').directive('vgMedia', [
    '$timeout',
    '$window',
    'VG_UTILS',
    'VG_STATES',
    function ($timeout, $window, VG_UTILS, VG_STATES) {
        return {
            restrict: 'E',
            require: '^videogular',
            ...
            link: function (scope, elem, attrs, API) {
                ...
                function isNativePlayBlacklisted(source) {
                    ...
                    return scope.vgNativePlayBlacklist.reduce(function (accumulator, currentNativeBlacklistFunc) {
                        return (
                            accumulator ||
                            (angular.isFunction(currentNativeBlacklistFunc) &&
                                currentNativeBlacklistFunc(source, userAgent))
                        );
                    }, false);
                }
            },
 ...
 */
('use strict');
angular.module('com.2fdevs.videogular').directive('vgNativeControls', [
    function () {
        return {
            restrict: 'A',
            require: '^videogular',
 ...
 */
('use strict');
angular.module('com.2fdevs.videogular').directive('vgPreload', [
    function () {
        return {
            restrict: 'A',
            require: '^videogular',
 ...
 */
('use strict');
angular.module('com.2fdevs.videogular').directive('vgTracks', [
    function () {
        return {
            restrict: 'A',
            require: '^videogular',
                ...
                pre: function (scope, elem, attr, API) {
                    ...
                    scope.setTracks = function setTracks(value) {
                        ...
                        if (isMetaDataLoaded) {
                            ...
                            API.mediaElement[0].addEventListener(
                                'loadedmetadata',
                                scope.onLoadMetaData.bind(scope),
                                false
                            );
                        }
                    };
 ...
 */
('use strict');
angular.module('com.2fdevs.videogular').directive('videogular', [
    function () {
        return {
            restrict: 'EA',
            scope: {
 ...
 **/
('use strict');
angular.module('com.2fdevs.videogular').service('vgConfigLoader', [
    '$http',
    '$q',
    '$sce',
    function ($http, $q, $sce) {
 ...
 **/
('use strict');
angular.module('com.2fdevs.videogular').service('vgFullscreen', [
    'VG_UTILS',
    function (VG_UTILS) {
...
('use strict');
angular.module('com.2fdevs.videogular').service('VG_UTILS', [
    '$window',
    function ($window) {
